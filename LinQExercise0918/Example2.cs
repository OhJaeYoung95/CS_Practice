...
public class StudentClass
{
    ...
    public void GroupBySingleProperty()
    {
        ...
        var queryLastNames = from student in students
                             group student by student.LastName into g
                             select g;
    ...
    public void GroupBySubstring()
    {
        ...
        var queryFirstLetters = from student in students
                                group student by student.LastName.First() into g
                                select g;
    ...
    public void GroupByRange()
    {
        ...
        var queryNumericRange = from student in students
                                orderby student.ExamScores.Sum()
                                group student by student.ExamScores.Sum() / 4 / 10 into g
                                select g;
    ...
    public void GroupByBoolean()
    {
        ...
        var queryGroupByAverages = from student in students
                                   group student by student.ExamScores.Sum() / 4 / 10 >= 8 into g
                                   select g;
    ...
    public void GroupByCompositeKey()
    {
        var queryHighScoreGroups = from student in students
                                   group student by new { FirstLetter = student.LastName.First(), Score = student.ExamScores[0] > 85 } into g
                                   select g;
